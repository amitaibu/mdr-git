 ...
 */
final class Version20200224124021 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        $this->addSql('CREATE TEMPORARY TABLE __temp__child_measurements AS SELECT id, weight, height, photo FROM child_measurements');
        ...
        , weight DOUBLE PRECISION NOT NULL, height DOUBLE PRECISION NOT NULL, photo VARCHAR(255) DEFAULT NULL COLLATE BINARY, PRIMARY KEY(id), CONSTRAINT FK_AD9E8689BF396750 FOREIGN KEY (id) REFERENCES measurements (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
        $this->addSql('INSERT INTO child_measurements (id, weight, height, photo) SELECT id, weight, height, photo FROM __temp__child_measurements');
