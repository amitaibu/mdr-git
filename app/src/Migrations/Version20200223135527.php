 ...
 */
final class Version20200223135527 extends AbstractMigration
{
    ...
    public function up(Schema $schema) : void
    {
        ...
        , weight DOUBLE PRECISION NOT NULL, height DOUBLE PRECISION NOT NULL, photo VARCHAR(255) DEFAULT NULL, PRIMARY KEY(id), CONSTRAINT FK_AD9E8689BF396750 FOREIGN KEY (id) REFERENCES measurements (id) ON DELETE CASCADE NOT DEFERRABLE INITIALLY IMMEDIATE)');
    ...
    public function down(Schema $schema) : void
    {
        ...
        , weight DOUBLE PRECISION NOT NULL, height DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
        $this->addSql('INSERT INTO child_measurements (id, weight, height) SELECT id, weight, height FROM __temp__child_measurements');
        $this->addSql('DROP TABLE __temp__child_measurements');
        $this->addSql('CREATE TEMPORARY TABLE __temp__mother AS SELECT id, birthday_estimated FROM mother');
        $this->addSql('DROP TABLE mother');
